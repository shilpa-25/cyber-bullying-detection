...
model = pickle.load(open("C:/Users/SHILPA BHURE/Desktop/Major/CyberBullying-Detection-in-Hinglish-Languages-Using-Machine-Learning--main/Safe_Chat/LinearSVC.pkl", 'rb'))
...
def prettyPrinter(self,data_1):
         # List of stopwords 
    my_file = open("C:/Users/SHILPA BHURE/Desktop/Major/CyberBullying-Detection-in-Hinglish-Languages-Using-Machine-Learning--main/Safe_Chat/stopwords.txt", "r")
    content = my_file.read()
    content_list = content.split("\n")
    my_file.close()
    tfidf_vector =  TfidfVectorizer(stop_words = content_list, lowercase = True,vocabulary=pickle.load(open("C:/Users/SHILPA BHURE/Desktop/Major/CyberBullying-Detection-in-Hinglish-Languages-Using-Machine-Learning--main/Safe_Chat/tfidf_vector_vocabulary.pkl", "rb")))
